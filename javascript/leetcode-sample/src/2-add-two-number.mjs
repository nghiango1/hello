...
export class ListNode {
   ...
   * @param {ListNode|undefined} next next linked node
   */
...
/**
 * @param {ListNode} l1 number need to be in reverse order
 * @param {ListNode} l2 number need to be in reverse order
 * @returns {ListNode} Total also in reverse order
 */
export const addTwoNumbers = function AddTwoNumberWithADescriptedName(l1, l2) {
