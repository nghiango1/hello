# hello
Hello is a repo contant a lot of personal notes along with working code to help you check if the evironment is properly working for each language/computer concept.
...
- `c#`: My niche [project](https://github.com/ylsama/RightClickMoveMode) use C#, it seem helped a lot of [people](https://www.nexusmods.com/stardewvalley/mods/2614?tab=posts) too
